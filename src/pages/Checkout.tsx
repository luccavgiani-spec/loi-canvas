  ...
  return (
    <div ref={containerRef}>
      ...
      <form id="loie-card-form" style={{ display: "none" }}>
        ...
        <input type="hidden" id="mp__issuer" />
      </form>
...
const Checkout = () => {
  ...
  const handlePixSuccess = useCallback((result: any) => {
    const qr = result.pix_qr_code || result.point_of_interaction?.transaction_data?.qr_code;
    const qrBase64 = result.pix_qr_code_base64 || result.point_of_interaction?.transaction_data?.qr_code_base64;
    if (qr) {
            ...
            >
              ...
              >
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "0.88rem", color: `${CHAR}77` }}>
                    Subtotal
                  </span>
                ...
                >
                  <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1rem", color: CHAR }}>
                    Total
                  </span>
                  <span
                    style={{
